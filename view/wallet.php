...
?>
<p><?php echo $lang['WALLET_BALANCE']; ?> [ <strong id="balance"><?php echo satoshitize($balance); ?></strong> <?=$short?> ]<br>[ <strong id="balance"><?php echo number_format($btcbalance, 8); ?></strong> BTC / <strong id="balance"><?php echo number_format($usdbalance,4); ?></strong> USD ]</p>
