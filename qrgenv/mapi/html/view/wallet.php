...
<br />
<?php
$qrdata = htmlspecialchars($_GET['qrscan']);
if ($admin)
{
  ?>
...
<form action="index.php" method="POST" class="clearfix" id="withdrawform">
    ...
    <input type="hidden" name="token" value="<?php echo $_SESSION['token']; ?>">
    <div class="col-md-4"><input type="text" class="form-control" name="address" placeholder="<?php echo $lang['WALLET_ADDRESS']; ?>" value="<?php echo $qrdata; ?>"></div>
